...
def __getattr__(name: str):
    ...
    # Simulation
        ...
        return SPKMC
    # Transmissibility
    elif name in ("TransmissibilityCalculator", "ExponentialExponentialTransmissibility",
                  "GammaExponentialTransmissibility", "NumericalTransmissibility", "EpidemicThreshold",
                  "create_transmissibility_calculator", "calculate_empirical_transmissibility",
                  "poisson_poisson_transmissibility", "gamma_exponential_transmissibility",
                  "epidemic_threshold_regular", "epidemic_threshold_er"):
        from spkmc.core import transmissibility as trans
        globals().update({
            "TransmissibilityCalculator": trans.TransmissibilityCalculator,
            "ExponentialExponentialTransmissibility": trans.ExponentialExponentialTransmissibility,
